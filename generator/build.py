...
def main():
    with open('AI-Security-Guardian/generator/workflow-spec.yaml', 'r') as f:
    ...
    for section in spec['sections']:
        ...
        sticky_width = max(800, len(section_nodes) * 250)
        sticky_height = 400
    ...
    with open('AI-Security-Guardian/AI_Security_Guardian_Mega.json', 'w') as f:
        json.dump(workflow, f, indent=2)
        
    print("Mega Workflow compiled successfully to AI-Security-Guardian/AI_Security_Guardian_Mega.json")
